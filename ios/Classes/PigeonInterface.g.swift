...
protocol PlatformService {
  ...
  func createSession(temperature: Double, randomSeed: Int64, topK: Int64, topP: Double?, loraPath: String?, enableVisionModality: Bool?, enableAudioModality: Bool?, systemInstruction: String?, toolDefinitionsJson: [String]?, enableThinking: Bool?, completion: @escaping (Result<Void, Error>) -> Void)
